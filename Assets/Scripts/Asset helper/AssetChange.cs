...
public class AssetChange : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        /*Checks(0, 89, 1, (int)_parent.transform.eulerAngles.z);
        Checks(90, 179, 2, (int)_parent.transform.eulerAngles.z);
        Checks(180, 269, 3, (int)_parent.transform.eulerAngles.z);
        Checks(270, 360, 4, (int)_parent.transform.eulerAngles.z);*/
